...
public abstract class BehaviourExecutor
    ...
    public void setAffectedByRabbot(boolean isAffectedByRabbot) {
        this.isAffectedByRabbot = isAffectedByRabbot;
    }

    public boolean getAffectedByRabbot() {
        return isAffectedByRabbot;
    }
