...
public class TestUtil {
    ...
    public void Enumerating1_a_list_gives_each_item_with_numbers() {
        assertThat(
                ...
                equalTo(
                        Arrays.asList(
                                IdxObj.make(1, "x"), IdxObj.make(2, "y"), IdxObj.make(3, "z"))));
    }
    ...
    public void Enumerating_a_list_gives_each_item_with_numbers() {
        assertThat(
                ...
                equalTo(
                        Arrays.asList(
                                IdxObj.make(0, "x"), IdxObj.make(1, "y"), IdxObj.make(2, "z"))));
    }
    ...
    public void Chaining_different_classes_yields_common_superclass() {
        ...
        BehaviourExecutor[] behaviourExecutors = new BehaviourExecutor[] { new Rabbit(3, 3, Direction.LEFT) };
